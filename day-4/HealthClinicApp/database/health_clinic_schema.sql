...
DELIMITER //
CREATE TRIGGER trg_appointment_audit_insert AFTER INSERT ON appointments FOR EACH ROW
BEGIN
    INSERT INTO audit_log (table_name, action, record_id)
    VALUES ('appointments', 'INSERT', NEW.appointment_id);
END //
CREATE TRIGGER trg_appointment_audit_update AFTER UPDATE ON appointments FOR EACH ROW
BEGIN
    INSERT INTO audit_log (table_name, action, record_id)
...
INSERT INTO doctor_specializations (doctor_id, specialization_id) VALUES (1, 1), (2, 2);
